...
const Signup = () => {
  ...
  }, [firstName, lastName, userName, email, phone, password, confirmPassword, referral_code, userType]);
  ...
  const handlePhoneChange = (value) => {
    ...
    if (!/^\d{10,14}$/.test(value)) {
      ...
      setPhoneError('Phone number must be between 10 and 14 digits');
    } else {
      setPhoneError('');
          ...
          <div className="flex flex-1 flex-col  justify-center space-y-5 max-w-md">
            <div style={{ background: 'white', padding: '0px 30px 0px 30px', borderRadius: '5px', boxShadow: '0 0 3px' }} >
              ...
              <div className="flex flex-col max-w-md space-y-4">
                ...
                <input style={{ border: '1px solid gray' }} type="text" placeholder="Referral Code (optional)" value={referral_code} onChange={(e) => setReferralCode(e.target.value)}
                  className="flex px-3 py-2 md:px-4 md:py-3 border-2 border-black rounded-sm font-medium placeholder:font-normal" />
