...
function UserHome() {
  ...
  const [totalGigsCount, setTotalGigsCount] = useState(0);
  const [activeGigsCount, setActiveGigsCount] = useState(0)
  const [inActiveGigsCount, setInActiveGigsCount] = useState(0)
  ...
  useEffect(() => {
      ...
      .then((response) => {
        ...
        setTotalClientAmount(response.data.total_client_amount);
      })
      .catch((error) => {
      ...
      api
      .get('/users/user-transaction-history/')
      .then((response) => {
      ...
      <div class="px-6 pt-6 2xl:container">
        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <div class="md:col-span-2 lg:col-span-1" >
            ...
            <div class="h-full py-8 px-6 space-y-6 rounded-xl border border-gray-300 bg-white shadow-lg">
              ...
              <div>
                ...
                <div class="mt-2 flex justify-center gap-4">
                  <h3 class="text-3xl font-bold text-gray-700">₹{totalAmountEarning}.00</h3>
                </div>
              </div>
              <table class="w-full text-gray-600">
                <tbody>
                  <tr>
                    <td class="py-2">Total Spend by Clients</td>
                    <td class="text-gray-500">₹{totalClientAmount}</td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td class="text-gray-500">₹{totalCommission}</td>
                    <td>
                      <svg class="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2"/>
                        <rect opacity="0.4" x="19" width="14" height="21" rx="1" fill="#e4e4f2"/>
                  ...
                  <tr>
                    ...
                    <td class="text-gray-500">₹{totalAmountEarning}</td>
                    <td>
                      <svg class="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2"/>
                          <rect opacity="0.4" x="19" width="14" height="21" rx="1" fill="#e4e4f2"/>
          ...
          <div>
            <div class="h-full py-6 px-6 rounded-xl border border-gray-300 bg-white shadow-lg">
              <div class="my-8">
                <h1 class="text-5xl font-bold text-gray-800">{totalGigsCount}*</h1>
                  <span class="text-gray-500">Total Gigs or Services provided for Clients</span>
                  </div>
                    ...
                    <table class="mt-6 -mb-2 w-full text-gray-600">
                      <tbody>
                        <tr>
                          <td class="py-2">Active Gigs</td>
                          <td class="text-gray-500">{activeGigsCount}</td>
                          <td>
                            <svg class="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2"/>
                              <rect opacity="0.4" x="19" width="14" height="21" rx="1" fill="#e4e4f2"/>
                        ...
                        <tr>
                          ...
                          <td class="text-gray-500">{inActiveGigsCount}</td>
                          <td>
                            <svg class="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2"/>
                              <rect opacity="0.4" x="19" width="14" height="21" rx="1" fill="#e4e4f2"/>
                ...
                <div>
                  <div class="lg:h-full py-8 px-6 text-gray-600 rounded-xl border border-gray-300 bg-white shadow-lg">
                    <svg class="w-40 m-auto" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <text x="50%" y="60%" text-anchor="middle" dominant-baseline="middle" font-size="14" font-weight="bold" fill="black">
                        {totalOrderCount}
                      </text>
                      <defs>
                    ...
                    <div class="mt-6">
                      <h5 class="text-xl text-gray-700 text-center">Stats of Orders</h5>
                    </div>
                    <table class="mt-6 -mb-2 w-full text-gray-600">
                      <tbody>
                        <tr>
                          <td class="py-2">Total Orders</td>
                          <td class="text-gray-500">{totalOrderCount}</td>
                          <td>
                            <svg class="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2"/>
                              <rect opacity="0.4" x="19" width="14" height="21" rx="1" fill="#e4e4f2"/>
                        ...
                        <tr>
                          ...
                          <td class="text-gray-500">{closedOrders}</td>
                          <td>
                            <svg class="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2"/>
                              <rect opacity="0.4" x="19" width="14" height="21" rx="1" fill="#e4e4f2"/>
                        ...
                        <tr>
                          ...
                          <td class="text-gray-500">{otherOrders}</td>
                          <td>
                            <svg class="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2"/>
                              <rect opacity="0.4" x="19" width="14" height="21" rx="1" fill="#e4e4f2"/>
                    ...
                    {transactionData.map((transaction, index) => (
                      <div key={index} className="lg:flex">
                        <div className="flex flex-col justify-between py-6 lg:mx-6">
                          ...
                          {index + 1}. Client: {transaction.user.username} paid ₹{transaction.total_amount.toFixed(2)} for the service: "{transaction.order.orderTitle}".
                          </p>
                        </div>
                      </div>
                    ))}
