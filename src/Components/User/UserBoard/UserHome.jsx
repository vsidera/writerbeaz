  ...
  useEffect(() => {
    ...
    api
      ...
      .then((response) => {
        ...
        setInProgressOrderCount(progress);
          ...
          <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <div class="md:col-span-2 lg:col-span-1" >
              ...
              <div class="h-full py-8 px-6 space-y-6 rounded-xl border border-gray-300 bg-white shadow-lg">
                ...
                <div>
                  <h5 class="text-xl text-gray-600 text-center">Balance</h5>
                ...
                <table class="mt-6 -mb-2 w-full text-gray-600">
                  <tbody>
                    <tr>
                      ...
                      <td class="text-gray-500">{pendingOrderCount}</td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td class="text-gray-500">{completedOrderCount}</td>
                      <td>
                        <svg class="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2" />
                          <rect opacity="0.4" x="19" width="14" height="21" rx="1" fill="#e4e4f2" />
                    ...
                    <tr>
                      ...
                      <td class="text-gray-500">{inProgressOrderCount}</td>
                      <td>
                        <svg class="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <rect opacity="0.4" width="17" height="21" rx="1" fill="#e4e4f2" />
                          <rect opacity="0.4" x="19" width="14" height="21" rx="1" fill="#e4e4f2" />
